...
if (ch == 1)
    for i=1+ext:r+ext
        for j=1+ext:c+ext
            ...
            %choose the minimum element and put it in the pixel
            res(i-ext,j-ext) = min(arr);
            p = 1;
        end
    end
